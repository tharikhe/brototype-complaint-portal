export default function PacManLoader() {
    return (
        ...
        .pac-man {
          ...
          aspect-ratio: 1;
          border-radius: 50%;
          background: radial-gradient(farthest-side, #000 98%, #0000) 1.7em 0.61em / 0.8em 0.8em no-repeat,
            #dc2626; /* Red-600 for Brototype theme */
        ...
        .point {
          ...
          width: 1em;
          height: 1em;
          background-color: #ffffff; /* White dots for contrast */
          border-radius: 50%;
        }
