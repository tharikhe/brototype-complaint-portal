...
export const SocialIcons = () => {
    return (
        <div className="flex justify-center gap-4 mt-8">
            {/* Instagram */}
            <div className="group relative w-10 h-10 bg-white rounded-full cursor-pointer flex items-center justify-center shadow-lg transition-all hover:shadow-[5px_5px_10px_rgba(24,23,23,0.8)]">
            ...
            {/* WhatsApp */}
            <div className="group relative w-10 h-10 bg-white rounded-full cursor-pointer flex items-center justify-center shadow-lg transition-all hover:shadow-[5px_5px_10px_rgba(24,23,23,0.8)]">
                <span className="absolute -top-10 left-1/2 -translate-x-1/2 scale-0 group-hover:scale-100 transition-transform duration-300 px-3 py-1 rounded text-xs text-white bg-[#25d366] whitespace-nowrap z-20">
                    WhatsApp
                </span>
                <div className="absolute bottom-0 left-0 w-full h-0 group-hover:h-full transition-[height] duration-300 ease-in-out bg-[#25d366] rounded-full z-0" />
                <div className="relative z-10 text-black group-hover:text-white transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
